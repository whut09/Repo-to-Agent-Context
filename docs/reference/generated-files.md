...
| User commands `commands/plusplus-task.md`, `commands/plusplus-verify.md` and skill `skills/opencode-plusplus/SKILL.md` under the OpenCode config dir | User-owned                         | No; installed by the Windows EXE                                          | Medium; in-session harness workflow, no command line needed        | `opencode-plusplus-setup-win-x64.exe`                                |
| `.opencode/commands/plusplus-task.md`, `.opencode/commands/plusplus-verify.md`                                                                       | Yes                                | Usually yes                                                               | Low; mirrors the global slash commands                             | `opencode-plusplus opencode init .` or `opencode-plusplus oc init .` |
