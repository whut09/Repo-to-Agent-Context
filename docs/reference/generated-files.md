...
| `.opencode/plugins/opencode-plusplus.ts`                                                                 | Yes                                | No by default; machine-local import                                       | Low; imports local OpenCode++ runtime                              | `opencode-plusplus` or `opencode-plusplus desktop init . --force`    |
