...
test("OpenCode sidecar plugin template uses the project plugin export shape", () => {
  ...
  assert.match(source, /Generated by: opencode-plusplus/);
  assert.match(source, /Package version: 1\.2\.3/);
  assert.match(source, /Generated at: 2026-06-20T00:00:00\.000Z/);
  assert.match(source, /import \{ createOpenCodePlusPlusSidecar \}/);
  assert.match(source, /export const OPENCODE_PLUSPLUS_PLUGIN_VERSION = "1\.2\.3"/);
  assert.match(source, /export const OPENCODE_PLUSPLUS_GENERATED_AT = "2026-06-20T00:00:00\.000Z"/);
